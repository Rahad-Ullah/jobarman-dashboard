...
export default function AddPlanForm() {
  ...
  const [features, setFeatures] = useState([
    ...
    { text: "Unlimited patient appointments" },
    { text: "Top priority visibility in search results" },
    {
      text: "Dedicated account manager / 24x7 premium support",
    },
  ]);

  const handleAddFeature = (feature: string) => {
    if (feature.trim()) {
      setFeatures([...features, { text: feature.trim() }]);
