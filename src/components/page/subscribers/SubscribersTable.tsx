...
const SubscriberTable = ({ users = [], filters, meta }) => {
  console.log(filters);
  ...
  const table = useReactTable<IUser>({
    data: users || [],
    columns: subscriberTableColumns as ColumnDef<IUser>[],
  ...
  return (
    <div className="w-full min-h-full flex flex-col">
      ...
      <section className="flex flex-wrap justify-between items-center gap-4 pb-4">
        <PageTitle>Subscriber Management</PageTitle>
      ...
      <section className="flex-1 flex flex-col justify-between gap-4 p-4 pt-2 bg-white rounded-xl">
        <DashboardTable table={table} columns={subscriberTableColumns} />
